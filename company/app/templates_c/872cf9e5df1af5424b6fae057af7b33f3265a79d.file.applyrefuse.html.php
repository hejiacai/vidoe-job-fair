<?php /* Smarty version Smarty-3.0.7, created on 2020-03-17 10:40:11
         compiled from "app\templates\resume/apply/applyrefuse.html" */ ?>
<?php /*%%SmartyHeaderCode:21265e70388b7c9368-03341061%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '872cf9e5df1af5424b6fae057af7b33f3265a79d' => 
    array (
      0 => 'app\\templates\\resume/apply/applyrefuse.html',
      1 => 1584332294,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21265e70388b7c9368-03341061',
  'function' => 
  array (
  ),
...
$_template->assign('par',"不合适的简历");$_template->assign('cur',"不合适的简历"); echo $_template->getRenderedTemplate();?><?php unset($_template);?>
    <div class="rMentRt">
...
/img/c/new_resume/headportrait.png<?php }?>"  />
                        ...
                        <div>
                            <p class="mTit1">
                                <b><?php if ($_smarty_tpl->tpl_vars['apply']->value['sex']=='男'){?>
...
-<?php echo $_smarty_tpl->tpl_vars['apply']->value['worklist'][0]['end_time'];?>
            ...
            <?php }else{ ?>
            <div class="rMentLit <?php if ($_smarty_tpl->tpl_vars['apply']->value['status']==5||$_smarty_tpl->tpl_vars['apply']->value['status']==6){?>rMentLxgray<?php }?>" >
...
<?php }?></b>
                    ...
                    <em class="<?php if ($_smarty_tpl->tpl_vars['apply']->value['status']==5||$_smarty_tpl->tpl_vars['apply']->value['status']==6||$_smarty_tpl->tpl_vars['apply']->value['status']==3){?>hue4<?php }elseif($_smarty_tpl->tpl_vars['apply']->value['status']==1){?>hue1<?php }elseif($_smarty_tpl->tpl_vars['apply']->value['status']==4){?>hue2<?php }?>"><?php echo $_smarty_tpl->tpl_vars['apply']->value['statusName'];?>
<?php if ($_smarty_tpl->tpl_vars['apply']->value['is_auto_refuse']&&$_smarty_tpl->tpl_vars['apply']->value['status']==3){?>（自动过滤）<?php }?></em>
...
" target="_blank"<?php }else{ ?>href="javascript:;"<?php }?> class="rMentLink">
                        <div class="mImgBg">
...
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('siteurl')->value['style'];?>
/img/c/new_resume/headportrait.png<?php }?>" /></p>
                        </div>
						</a>
...
" target="_blank"<?php }else{ ?>href="javascript:;"<?php }?> class="rMentLink ">
                            <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['apply']->value['school'];?>
<?php $_tmp2=ob_get_clean();?><?php if (!empty($_tmp2)){?><p class="mTit3"><?php echo $_smarty_tpl->tpl_vars['apply']->value['school'];?>
<?php if (!empty($_smarty_tpl->tpl_vars['apply']->value['major_desc'])){?><span>|</span><?php echo $_smarty_tpl->tpl_vars['apply']->value['major_desc'];?>
<?php }?><span>|</span><?php echo $_smarty_tpl->tpl_vars['apply']->value['school_degree'];?>
</p><?php }?>
                            <?php if (!empty($_smarty_tpl->tpl_vars['apply']->value['worklist'])){?>
