<?php /* Smarty version Smarty-3.0.7, created on 2020-03-17 10:28:06
         compiled from "app\templates\./new_indexv2.html" */ ?>
<?php /*%%SmartyHeaderCode:178945e7035b6bd3e46-13790954%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '20a21fb3c85017800c657c90aa1961dd5fd2fc21' => 
    array (
      0 => 'app\\templates\\./new_indexv2.html',
      1 => 1584412081,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178945e7035b6bd3e46-13790954',
  'function' => 
  array (
  ),
...
/img/grade_img01.png) no-repeat; position: fixed; top: 50%; left: 50%; margin: 60px 0 0 -620px;}
...
/img/company/hire-teacher.jpg">
				...
				<!--这里是挂区县的广告-->
				<a style="display: none;cursor: pointer;" target="_blank" class="md_index_banner" href="<?php echo $_smarty_tpl->getVariable('siteurl')->value['main'];?>
...
?>
					<li><a href="http://<?php echo $_smarty_tpl->tpl_vars['v']->value['url'];?>
...
<?php }?><?php }else{ ?>请选择招聘人<?php }?></p>
						<ul class="select-list">
							<li class="md_index_account_select"><a href="<?php echo smarty_modifier_replace($_smarty_tpl->getVariable('siteurl')->value['company'],'http:','');?>
...
<?php }?></a></li>
					...
					<div class="refresh-job">
						<!--<a href="/partjob/addjobselect/" target="_blank" class="md_index_pubjob firmRefresh">发布职位</a>-->
                        <a href="javascript:;" class="md_index_pubjob firmRefresh">发布职位</a>
...
/<?php echo (($tmp = @$_smarty_tpl->getVariable('companyresources')->value['refresh_perday'])===null||$tmp==='' ? 0 : $tmp);?>
						...
						<div class="alert-warniong mgt15" style="top:40px;">
...
/img/account/add_appresume.jpg" style="float: left;margin-right: 20px" />
						...
						<?php }?>
						<div class="freshTit" style="width:90px">
...
">
								<span>自动刷新</span><em id="auto-refresh" style="margin: 2px 4px 0"  <?php if (($_smarty_tpl->getVariable('is_auto')->value==0&&$_smarty_tpl->getVariable('companyinfo')->value['isautorefresh']==1)){?>class="cut"<?php }?>></em>
...
" class="recommend_job">推荐的简历</a><a class="closeTipBtn" href="javascript:void(0);">x</a>
								...
								<span class="subFresh07">已过期</span>
...
" class="recommend_job">推荐的简历</a><a class="closeTipBtn" href="javascript:void(0);">x</a>
									...
									<!--到期时间-->
									<span class="subFresh07"><?php echo $_smarty_tpl->tpl_vars['job']->value['day'];?>
</span>
								<span class="subFresh08">
									<a href="javascript:;"  class="job_close md_index_close" data-id="<?php echo $_smarty_tpl->tpl_vars['job']->value['job_id'];?>
" style="margin-right: 10px">关闭</a>
									<?php if ($_smarty_tpl->tpl_vars['job']->value['is_show_lazy']){?>
									<a href="javascript:;" class="lazy md_index_delay" data-id="<?php echo $_smarty_tpl->tpl_vars['job']->value['job_id'];?>
">延期</a>
									<?php }?>
								</span>
...
" target="_blank">立即免费发布职位</a></div>
						<div class="none-job-data" style="display: <?php if (count($_smarty_tpl->getVariable('job_lists')->value)>0&&$_smarty_tpl->getVariable('company_level')->value==1&&in_array($_smarty_tpl->getVariable('is_audit')->value,array(0,3))){?>block<?php }else{ ?>none<?php }?>" >
							您尚未完成企业认证，发布的职位无法展示~
...
" target="_blank">
						...
						<div class="none-job-data" style="display: <?php if (count($_smarty_tpl->getVariable('job_lists')->value)>0&&$_smarty_tpl->getVariable('company_level')->value==1&&$_smarty_tpl->getVariable('is_audit')->value>0&&$_smarty_tpl->getVariable('is_audit')->value!=3){?>block<?php }else{ ?>none<?php }?>">
...
&site=qq&menu=yes" target="_blank">
                        ...
                        <div class="none-job-data" style="display: <?php if (count($_smarty_tpl->getVariable('job_lists')->value)>0&&empty($_smarty_tpl->getVariable('company_level',null,true,false)->value)&&!$_smarty_tpl->getVariable('is_free_vip')->value){?>block<?php }else{ ?>none<?php }?>">您尚未开通会员，发布的职位无法展示~<a href="//wpa.qq.com/msgrd?v=3&uin=<?php echo trim($_smarty_tpl->getVariable('hrManager')->value['qq']);?>
...
&site=qq&menu=yes">立即开通</a>
				...
				<div class="open-vip-teiqan">
					<p class="itme">
						...
						<span>5、下载简历最高优惠<strong>80%</strong></span>
					</p>
				</div>
...
/img/company/newDemand.png" class="newDemand"/>最新人才
					...
					<a class="md_index_remmonperson_more" style="display: none;<?php if (empty($_smarty_tpl->getVariable('recommend',null,true,false)->value)){?>display: block;<?php }?>" onclick="gotoSearch()" href="javascript:;" >更多<img src="<?php echo $_smarty_tpl->getVariable('siteurl')->value['style'];?>
/img/company/company_icon_v2_move2.jpg" style="margin-left:3px" /></a>
					<script type="text/javascript">
                        function gotoSearch(){
...
" />
					...
					<dd class="infor">
						<h2><a href="/account/" target="_blank" class="md_index_selfnameclick"><?php echo $_smarty_tpl->getVariable('companyinfo')->value['company_shortname'];?>
</a></h2>
...
<!--						<?php }?>-->
						...
						<?php }?>
						<span class="completeTip" style="<?php if ($_smarty_tpl->getVariable('companyInfoPercent')->value<70||$_smarty_tpl->getVariable('show_light2')->value!=1){?>display: block;<?php }else{ ?>display: none;<?php }?>">
...
/img/company/company_icon_v2_move2.jpg" style="margin-left:3px"></a>-->
				...
				<div class="share-other">
					...
					<div id="share_h5"><a class="link md_index_mh5" href="javascript:void(0);">H5页面</a></div>
				</div>
...
<?php }?>/<?php echo (($tmp = @$_smarty_tpl->getVariable('companyresources')->value['default_job_num'])===null||$tmp==='' ? 0 : $tmp);?>
				...
				<?php }elseif($_smarty_tpl->getVariable('account_type')->value=="NotMember"){?>
				<?php }else{ ?>
				<!--此种情况，智能推广、完整短信功能关闭-->
				<ul class="vip_box clearfix">
					<!-- 推广金 -->
...
<?php }?>/<?php echo (($tmp = @$_smarty_tpl->getVariable('companyresources')->value['default_job_num'])===null||$tmp==='' ? 0 : $tmp);?>
					...
					<li class="not-margin">
						<p><strong>236分钟</strong><span>剩余视频时长</span></p>
					</li>
				</ul>
				<?php }?>
...
';
	...
	<script type="text/javascript">
        var  Feedback,resumeCompleteDialog;
...
/company/ImproveCompanyInfo" class="cpromisetip">马上填写</a>',
                ...
                '</dd></dl>',
                '</div>'].join('');
            var infoExteriorDialog = new Dialog({
                close: 'x',
                idName: 'jian_dialog',
                title: '提示',
                content: thtml,
            ...
            infoExteriorDialog.query('#info_exterior').on('click',function(){
                infoExteriorDialog.hide();
                cookie.set('info_exterior', 1, {path:'/',domain:"<?php echo base_lib_Constant::COOKIE_DOMAIN;?>
"});
            });
            $(".md_index_pubjob").click(function(){
                if (getCookie('info_exterior')) {
                    infoExteriorDialog.show();
                } else {
                    window.open('/partjob/addjobselect/' , '_blank');
                }
            });
...
'
			...
			/* company_annual_report_dialog.setContent('<span style="display:block;text-align:center;font-size:18px;padding-bottom:10px;font-weight:bold;color: red">2019年企业招聘报告请查收！</span><img style="display:block;width:150px; height:150px;margin:0 auto;" src="<?php echo $_smarty_tpl->getVariable('companyAnnualReport')->value;?>
...
', null, function (json) {
            ...
            function showJobRefreshDialog(json){
                var has_refreshed_job_num = parseInt(json.job_num);
                ...
                var jobRefreshHtml = '<div style="padding:10px">'+
                    ...
                    '<p style="font-size: 14px;color: #666;border-bottom: 1px dashed #e9e8e8;padding-bottom: 10px">已批量刷新 '+has_refreshed_job_num+' 条职位信息<br />'+json.not_refresh_num+' 条职位信息没有自动刷新。 原因：48小时未查看投递的简历。<br />如需刷新请在列表中手动刷新，如已停招请关闭职位</p>'+
                    ...
                    $.each(json.not_refresh_job_list, function(i, n){
                        if(i%2 == 0)
                            jobRefreshHtml += '<tr class="one"><td style="text-align: left">'+n.station+'</td><td>'+n.account_user_name+'</td><td>'+n.no_reply_num+'</td><td><a data-id="'+n.job_id+'" href="javascript:;" class="singleRefrsh">刷新</a><a data-id="'+n.job_id+'" href="javascript:;" style="margin-right: 0" class="job_close md_index_close">关闭</a></td></tr>';
                        else
                            jobRefreshHtml += '<tr><td style="text-align: left">'+n.station+'</td><td>'+n.account_user_name+'</td><td>'+n.no_reply_num+'</td><td><a data-id="'+n.job_id+'" href="javascript:;" class="singleRefrsh">刷新</a><a data-id="'+n.job_id+'" href="javascript:;" style="margin-right: 0" class="job_close md_index_close">关闭</a></td></tr>';
                    });
...
', null, function (data) {
                ...
                jobRefreshDialog.query('.singleRefrsh').on('click', function() {
                    jobRefreshDialog.hide();
                    $.getJSON('<?php echo smarty_function_get_url(array('rule'=>"/index/singleRefrshDo/",'data'=>"v=' + Math.random() + '"),$_smarty_tpl);?>
', {refresh_job_id:$(this).attr('data-id')}, function (data) {
                        if(data.status){
